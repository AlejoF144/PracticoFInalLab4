        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MarcaDeTarjeta = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UsuarioDomicilios_Domicilio_DomicilioId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsuarioTarjeta", x => new { x.UsuarioId, x.TarjetaId });
                    table.ForeignKey(
                        name: "FK_UsuarioTarjeta_MetodoDePagos_TarjetaId",
                        column: x => x.TarjetaId,
                        principalTable: "MetodoDePagos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsuarioTarjeta_Usuarios_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usuarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsuarioTarjeta_TarjetaId",
                table: "UsuarioTarjeta",
                column: "TarjetaId");
        }
